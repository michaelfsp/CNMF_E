...
%nam = '/home/michael/data/priority/black1/recording_20160717_143955_concatenated_mcorr_fft.tif';
nam = [];
...
[filepath,name,ext] = fileparts(cnmfe_path);
eval(sprintf('save %s%sresults.mat results', filepath, filesep));
